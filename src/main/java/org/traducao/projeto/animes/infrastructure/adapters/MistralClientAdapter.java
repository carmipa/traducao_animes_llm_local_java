package org.traducao.projeto.animes.infrastructure.adapters;
...
import org.traducao.projeto.animes.domain.exceptions.RespostaLlmVaziaException;
import org.traducao.projeto.animes.domain.ports.MistralPort;
import org.traducao.projeto.animes.infrastructure.config.LlmProperties;
import org.traducao.projeto.animes.infrastructure.dtos.RecordsMistral.*;
...
public class MistralClientAdapter implements MistralPort {
    ...
    private static final String PROMPT_SISTEMA = """
        ...
        Marcadores no formato [[TAG0]], [[TAG1]] etc. e sequencias de controle \\N, \\n e \\h devem ser copiados exatamente como estao: nao traduza, nao remova e nao adicione novos marcadores.
        """;
    ...
    public TraducaoLote traduzir(Lote lote) {
        ...
        for (int tentativa = 1; tentativa <= MAX_TENTATIVAS; tentativa++) {
            try {
                ...
                String traduzidoText = resposta.choices().getFirst().message().content();
                ...
                List<String> linhasTraduzidas = List.of(traduzidoText.split("\n"));
