...
public class ContextoWarInPocket implements ProvedorContexto {
    ...
    private static final String LORE = """
        ...
        - Principais nomes: Alfred "Al" Izuruha, Bernard "Bernie" Wiseman, Christina "Chris" Mackenzie, Mikhail Kaminsky, Hardy Steiner, Gabriel Ramirez Garcia, Andy Strauss.
